	...
	<body onload="hrm.common.check_order();">
		...
		<form id="actionSrc" name="actionSrc" action="allLeaveSearch.action"  method="POST">
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblSearchCondition">
							<tr>
								...
								<s:select label="请假种类" id="es_Bean_typeNo" name="es_Bean.typeNo" list="lrTypeList"  listKey="ltNo" listValue="ltName" emptyOption="true" />
								<td rowspan="2">				
									<input title="[Alt+F]" accesskey="F" name="submit_search" id="submit_search" class="button" type="submit" value="查询">
									<input title="[Alt+A]" accesskey="A" name="submit_all" id="submit_all" class="button" type="button" onclick="window.location='allLeaveSearch.action'" value="重置">
								</td>
							</tr>
							<tr>
								...
								<s:select label="请假状态" id="es_Bean_statu" name="es_Bean.statu"  list="statusMap" listKey="key" listValue="value" emptyOption="true"/>
							</tr>
						</table>
					</td>
				</tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
			    <tr><td align="right">本次查询共得到<s:property value="page.totalRows" />条请假记录&nbsp;</td></tr>
			</table>
			<table cellpadding="0" cellspacing="0" width="100%" border="0" class="gridtableList">
								...
								<s:if test="lrStatus==@com.hr.base.Status@LR_STATUS_HR_APPROVE">
									<ty:auth auths="401,2 or 401,3">
										 <a href="#" onclick="hrm.common.submitForm('actionSrc','deptHrApproveLRInit.action','lrUpdateId','<s:property value='lrId'/>');" >
											<img src="../resource/images/reportle.gif" alt='销假' border='0' />
										</a>
									</ty:auth>
								</s:if>
				...
				<s:else>
					<tr>
						<td align="center" colspan="11">不存在符合条件的请假申请！</td>
					</tr>
				</s:else>
			</table>
