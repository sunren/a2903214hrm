...
<html>
	...
	<body>
		<ww:component template="bodyhead">
			<ww:param name="pagetitle" value="'HR备案'" />
			<ww:param name="helpUrl" value="17" />
		</ww:component>
		<table width="100%">
			<tr>
				<td valign="top">
					<tabs:tabbedPane tabParam="tab" defaultTab="1" sessionKey="tab">
					    ...
					    <tr>
					        <tabs:activeTab   tabId="1"><td class="activeTab"  ><ajax:link targetElement="bodyId"><a href="empsexamin_hr_search.jsp?tab=1">HR备案请假列表</a></ajax:link></td></tabs:activeTab>
					        <tabs:inactiveTab tabId="1"><td class="inactiveTab"><ajax:link targetElement="bodyId"><a href="empsexamin_hr_search.jsp?tab=1">HR备案请假列表</a></ajax:link></td></tabs:inactiveTab>
					        <tabs:activeTab   tabId="2"><td class="activeTab"  ><ajax:link targetElement="bodyId"><a href="empsexamin_hr_search.jsp?tab=2">HR备案加班列表</a></ajax:link></td></tabs:activeTab>
					        <tabs:inactiveTab tabId="2"><td class="inactiveTab"><ajax:link targetElement="bodyId"><a href="empsexamin_hr_search.jsp?tab=2">HR备案加班列表</a></ajax:link></td></tabs:inactiveTab>
						</tr>
					    <tr>
					    	...
					    	<tabs:tabContent tabId="1">
					    		<IFRAME ID="IFrame1" name="IFrame1" marginWidth="0" marginHeight="0" FRAMEBORDER="0" align="left"
						 			 width="100%" height="430" SRC="hrLeaveSearch.action" style="overflow-y:auto;"></IFRAME>
					        </tabs:tabContent>
					        <tabs:tabContent tabId="2">
					        	<IFRAME ID="IFrame1" name="IFrame1" marginWidth="0" marginHeight="0" FRAMEBORDER="0" align="left"
						 		 width="100%" height="430" SRC="hrOvertimeSearch.action" style="overflow-y:auto;"></IFRAME>
					        </tabs:tabContent>
					    	</td>
					    </tr>
						</table>
