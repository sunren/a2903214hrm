...
<html>
	<body onload="deliver()">
		...
		<form id="UpdateRecruitplan" name="UpdateRecruitplan" method="POST" action="UpdateRecruitplanADM.action">
		 ...
		 <ww:token />
			...
			<TABLE width="100%" >
				<tr>
				<td width="10%" align="right">职位名称<font color="red">*</font>：</td>
				<td width="25%" align="left">
				<ww:select list="jobTitles" name="recruitplan.recpJobTitle.jobtitleNo" listKey="jobtitleNo" listValue="jobtitleName" emptyOption="true"></ww:select>
				</td>
			    ...
			    <td><ww:textfield id="startDate" name="recruitplan.recpStartDate" required="true" size="21"  />
			    <img onclick="WdatePicker({el:'startDate',dateFmt:'yyyy-MM-dd'})" src="../resource/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" style="cursor:pointer" align="absmiddle">								
			    </td>
				</tr>				
				<tr>
				    ...
				    <td><ww:textfield id="endDate" name="recruitplan.recpEndDate" required="true" size="21"  />
				    <img onclick="WdatePicker({el:'endDate',dateFmt:'yyyy-MM-dd'})" src="../resource/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" style="cursor:pointer" align="absmiddle">								
				    </td>
				</tr>
