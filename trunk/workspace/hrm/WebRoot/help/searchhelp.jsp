					...
					<input type="hidden" id="hcBrief<ww:property value="id"/>" value="<ww:property value="hcBrief"/>"/>
						<script>
							...
							<ww:if test="classId==id">
								document.getElementById('ulClass<ww:property value="hcFather.id"/>').innerHTML+="<li id='thissecondmenu' ><a href='searchHelp.action?classId=<ww:property value="id"/>'><ww:property value="hcClassName"/></a></li>";
							...
							<ww:else>
								...
								document.getElementById('ulClass<ww:property value="hcFather.id"/>').innerHTML+="<li><a href='searchHelp.action?classId=<ww:property value="id"/>'><ww:property value="hcClassName"/></a></li>";
							</ww:else>
						</script>
					</ww:if>
					<ww:else>
						...
						<ul id="ulClass<ww:property value="id"/>" class="secondmenu" style="display:none" onclick="showFatherName(<ww:property value="id"/>)"></ul>
					</ww:else>
				</ww:iterator>
			</dl>
		</div>
...
<script>
 ...
 showFatherName(idb);
 //alert(document.getElementById('son_menu').parentNode.parentNode.innerHTML);
