...
<html>
	...
	<body>
		<ww:component template="bodyhead">
			<ww:param name="pagetitle" value="'经理审批'" />
			<ww:param name="helpUrl" value="16" />
		</ww:component>
		<table width="100%">
			<tr>
				<td valign="top">
					<tabs:tabbedPane tabParam="tab" defaultTab="1" sessionKey="tab">
					    ...
					    <tr>
					        <tabs:activeTab   tabId="1"><td class="activeTab"  ><ajax:link targetElement="bodyId"><a href="empsexamin_dept_search.jsp?tab=1">审批请假列表</a></ajax:link></td></tabs:activeTab>
					        <tabs:inactiveTab tabId="1"><td class="inactiveTab"><ajax:link targetElement="bodyId"><a href="empsexamin_dept_search.jsp?tab=1">审批请假列表</a></ajax:link></td></tabs:inactiveTab>
					        <tabs:activeTab   tabId="2"><td class="activeTab"  ><ajax:link targetElement="bodyId"><a href="empsexamin_dept_search.jsp?tab=2">审批加班列表</a></ajax:link></td></tabs:activeTab>
					        <tabs:inactiveTab tabId="2"><td class="inactiveTab"><ajax:link targetElement="bodyId"><a href="empsexamin_dept_search.jsp?tab=2">审批加班列表</a></ajax:link></td></tabs:inactiveTab>
						</tr>
					    <tr>
					    	...
					    	<tabs:tabContent tabId="1">
					    		<IFRAME ID="IFrame1" name="IFrame1" marginWidth="0" marginHeight="0" FRAMEBORDER="0" align="left"
						 			 width="100%" height="430" SRC="deptLeaveSearch.action" style="overflow-y:auto;"></IFRAME>
					        </tabs:tabContent>
					        <tabs:tabContent tabId="2">
					        	<IFRAME ID="IFrame1" name="IFrame1" marginWidth="0" marginHeight="0" FRAMEBORDER="0" align="left"
						 		 width="100%" height="430" SRC="deptOvertimeSearch.action" style="overflow-y:auto;"></IFRAME>
					        </tabs:tabContent>
					    	</td>
					    </tr>
						</table>
