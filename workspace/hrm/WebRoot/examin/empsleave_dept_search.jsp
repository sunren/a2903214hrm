...
<title>员工请假列表</title>
	...
	<body onload="hrm.common.check_order();">
		...
		<form id="actionSrc" name="actionSrc" action="deptLeaveSearch.action"  method="POST">		
			<!--隐藏信息-->
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable" >
				<tr>
					...
					<td  rowspan="2">				
						...
						<input title="[Alt+A]" accesskey="A" name="submit_all" id="submit_all" class="button" type="button" onclick="window.location='deptLeaveSearch.action'" value="重置">
					</td>
				</tr>
			</table>
			<p align="left">&nbsp;</p> 
...
function batchReject(){
   commonbatch('approveOper','logComents_r','lf_Bean_lrAppComment','actionSrc','deptApproveOrReject.action')
}      
</script>
