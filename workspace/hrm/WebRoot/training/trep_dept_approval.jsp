...
<body onload="check_order();">
	<ww:component template="bodyhead">
		<ww:param name="pagetitle" value="'培训计划部门审批'" />
		<ww:param name="helpUrl" value="'51'" />
	</ww:component>

	<ww:form name="deptApproveForm" id="deptApproveForm" action="trepDeptApprove" namespace="/training" method="POST">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formtable">
				<tr>
					<td>
						...
						<tr>							
							<ww:textfield label="员工" id="emp" name="emp" size="12" maxlength="32" />							
					...
					<td>
						...
						<input title="[Alt+C]" accesskey="C" id="reset_Button" class="button" type="button" onClick="window.location='trepDeptApprove.action'" value="重置">
						<br>
					</td>
				</tr>
			</table>
		...
		<table id="deptaApprovalTable" cellpadding="0" cellspacing="0" width="100%" border="0" class="gridtableList">
			...
			<ww:if test="page.isSplit()">
				<tr>
					<td colspan="12" align="right" class="listViewPaginationTdS1">
						...
						<a href="#" onclick="splits('first','deptApproveForm');"><img
								src='../resource/images/start.gif' width='11' height='9'
								alt='开始'>开始</a>
						<a href="#" onclick="splits('previous','deptApproveForm');"><img
						...
						条）
						<a href="#" onclick="splits('next','deptApproveForm');">下页<img
								src='../resource/images/next.gif' width='6' height='9'></a>
						<a href="#" onclick="splits('last','deptApproveForm');">最后<img
				...
				<th><a href="#" onclick="order_submit('trpTraineeNo.empName','deptApproveForm');">员工姓名</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTraineeNo.empName_img'></th>
				<th><a href="#" onclick="order_submit('trpTrcp.trcpCourseNo.trcName','deptApproveForm');">课程名称</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTrcp.trcpCourseNo.trcName_img'></th>
				<th><a href="#" onclick="order_submit('trpTrcp.trcpLocation','deptApproveForm');">培训地点</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTrcp.trcpLocation_img'></th>				
				<th><a href="#" onclick="order_submit('trpTrcp.trcpStartDate','deptApproveForm');">开始日期</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTrcp.trcpStartDate_img'></th>
				<th><a href="#" onclick="order_submit('trpTrcp.trcpEndDate','deptApproveForm');">结束日期</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTrcp.trcpEndDate_img'></th>
				<th><a href="#" onclick="order_submit('trpTrcp.trcpBudgetHour','deptApproveForm');">培训小时数</a><img src='../resource/images/arrow_.gif' width='8' height='10' id='trpTrcp.trcpBudgetHour_img'></th>
				<th> 状态 </th>	
				<th> 操作 </th>
			</tr>
			<ww:if test="!trepList.isEmpty()">
						...
						<tr  id="trep_dept_tr<ww:property value='trpId'/>">
								<td align="center">
								...
								<td onMouseOut="hideLog();"><span style="font-size: 12px; color: #002780; text-decoration: underline; cursor: pointer" 
										onClick="LogShowDiv('<ww:property value="trpId"/>', 'tremployeeplan',this);"><ww:property value="getTreStatus(trpStatus)" /></span></td>						
								   <td align="center">
									<span class="view" onclick="document.getElementById('FlagDeptHR').value='Dept';document.getElementById('approve_recordId').value='<ww:property value='trpId'/>';
											showApproveComment('agree','<ww:property value="trpTraineeNo.empName" />','<ww:property value='trpTrcp.trcpCourseNo.trcName'/>');">
											<img src="../resource/images/MgrApprove.gif" alt='同意' border='0' /></span>
									<span class="view" onclick="document.getElementById('FlagDeptHR').value='Dept';document.getElementById('approve_recordId').value='<ww:property value='trpId'/>';
											showApproveComment('reject','<ww:property value="trpTraineeNo.empName" />','<ww:property value='trpTrcp.trcpCourseNo.trcName'/>');">
											<img src="../resource/images/MgrReject.gif" alt='拒绝' border='0' /></span>
							</td>
						</tr>
				</ww:iterator>
		</ww:if>
		...
		<ww:if test="!trepList.isEmpty()">
		<input id="submitBt" class="button" type="button" onclick="document.getElementById('FlagDeptHR').value='Dept';batchApprovedPlan();" value="同意">		
		</ww:if>
