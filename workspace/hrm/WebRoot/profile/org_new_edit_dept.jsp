...
<form action="saveBranchDept.action" id="saveBranchDept" name="saveBranchDept" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gridtableList" align="center">
	<tr>
		<td width="25%" align="right">部门名称<span class="required">*</span>：</td>
		...
		<td width="25%" align="right">部门描述：</td>
		<td width="25%" align="left">
	...
	<tr>
		...
		<td align="left">
		    <s:if test="dept.deptHead!=null"><s:property value="dept.deptHead.empName"/></s:if>
		</td>
	</tr>
	</s:else>
	...
	<tr>
		...
		<td align="left">
		    <s:if test="dept.departmentStatus==1">启用</s:if><s:elseif test="dept.departmentStatus==1">停用</s:elseif>
		</td>
	...
	<tr>
	    <td align="center" colspan="4">
		    <input type="button" name="save" value="保存" onclick="saveDept();"/>
	    </td>
	</tr>
</table>
</form>
