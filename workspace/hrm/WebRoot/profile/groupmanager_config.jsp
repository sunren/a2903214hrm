...
<div class="btnlink">
    <a href="#" id="link_add_orghead_group">新增</a>
	<a href="#" id="link_delete_orghead_group">删除</a>
	<a href="#" id="link_update_orghead_group">修改</a>
	<input type="hidden" id="link_sort_orghead_group" />
</div>
<br>
<div id="dialog_groupmanager" title="小组组长设置" >  
	    ...
	    <table cellpadding="0" cellspacing="1" width="100%">
            ...
            <tr>
               <td colspan="2" align="center">
                   <input id="btn_add_orghead_group" type="button" value="保存" />
				   <input id="btn_update_orghead_group" type="button" value="保存" />
				   <input id="btn_close_orghead_group" type="button" value="关闭" />
               </td>
