...
<script type="text/javascript">
	...
	<#-- value --><#t/>
	<@s.set name="tmpVal" value="parameters.nameValue" /><#t/>
	<#if (stack.findValue('#tmpVal')?has_content)><#t/>
		oFCKeditor_${parameters.id}.Value = '<@s.property escape="false" value="parameters.nameValue" />' ;
	</#if><#t/>
	...
	<#if parameters.editorAreaCss?exists><#t/>
		oFCKeditor_${parameters.id}.Config['EditorAreaCSS'] = '<@s.url value=parameters.editorAreaCss?string />' ;
	</#if><#t/>
	<#-- baseHref --><#t/>
	...
	<#if parameters.stylesXmlPath?exists><#t/>
		oFCKeditor_${parameters.id}.Config['StylesXmlPath'] = '<@s.url value=parameters.stylesXmlPath?string />' ;
	</#if><#t/>
	<#-- templatesXmlPath --><#t/>
	<#if parameters.templatesXmlPath?exists><#t/>
		oFCKeditor_${parameters.id}.Config['TemplatesXmlPath'] = '<@s.url value=parameters.templatesXmlPath?string />' ;
	</#if><#t/>
	<#-- linkBrowserURL --><#t/>
	<#if parameters.linkBrowserURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['LinkBrowserURL'] = '<@s.url value=parameters.linkBrowserURL?string />' ;
	</#if><#t/>
	<#-- imageBrowserURL --><#t/>
	<#if parameters.imageBrowserURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['ImageBrowserURL'] = '<@s.url value=parameters.imageBrowserURL?string />' ;
	</#if><#t/>
	<#-- flashBrowserURL --><#t/>
	<#if parameters.flashBrowserURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['FlashBrowserURL'] = '<@s.url value=parameters.flashBrowserURL?string />' ;
	</#if><#t/>
	<#-- linkUploadURL --><#t/>
	<#if parameters.linkUploadURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['LinkUploadURL'] = '<@s.url value=parameters.linkUploadURL?string />' ;
	</#if><#t/>
	<#-- imageUploadURL --><#t/>
	<#if parameters.imageUploadURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['ImageUploadURL'] = '<@s.url value=parameters.imageUploadURL?string />' ;
	</#if><#t/>
	<#-- flashUploadURL --><#t/>
	<#if parameters.flashUploadURL?exists><#t/>
		oFCKeditor_${parameters.id}.Config['FlashUploadURL'] = '<@s.url value=parameters.flashUploadURL?string />' ;
	</#if><#t/>
	<#-- allowImageBrowse --><#t/>
	<#if parameters.allowImageBrowse?exists><#t/>
		oFCKeditor_${parameters.id}.Config['ImageBrowser'] = '<@s.url value=parameters.allowImageBrowse?string />' ;
	</#if><#t/>
	<#-- allowLinkBrowse --><#t/>
	<#if parameters.allowLinkBrowse?exists><#t/>
		oFCKeditor_${parameters.id}.Config['LinkBrowser'] = '<@s.url value=parameters.allowLinkBrowse?string />' ;
	</#if><#t/>
	<#-- allowFlashBrowse --><#t/>
	...
	<#if parameters.smileyPath?exists><#t/>
		oFCKeditor_${parameters.id}.Config['SmileyPath'] = '<@s.url value=parameters.smileyPath?string />' ;
	</#if><#t/>
	<#-- smileyImages --><#t/>
