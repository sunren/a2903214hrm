...
<script language="JavaScript" type="text/JavaScript" src="../resource/js/profile/emp.js"></script>
...
<body>
	<div id="create_applier" align="left" style="z-index:0;">		
		<ww:component template="bodyhead">
			<ww:param name="pagetitle" value="'新增应聘者'" />
			<ww:param name="helpUrl" value="'45'" />
		</ww:component>
		                 
		<ww:form id="createApplier" name="createApplier" action="recruitapplierCreateDetail.action" namespace="/recruitment"  method="POST" enctype="multipart/form-data">
			 <ww:token />
			<table id="createTable" name="createTable" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<ww:hidden name="applier.id"></ww:hidden>	
			              	...
			              	<td width="10%" align="right">招聘计划<font color="red">*</font>：</td><td width="20%" align="left" >	<ww:textfield  id="plan_job_title"  name="applier.recaPlan.recpNo" value="%{plan.recpNo}" size="20" readonly="true" maxlength="32" required="true"></ww:textfield> </td>   
			            	<ww:hidden id="applier.recaPlan.id" name="applier.recaPlan.id"  value="%{plan.id}"/>			            	
			            	<ww:hidden id="id" name="id"  value="%{plan.id}"/>
			            	<ww:hidden id="plan_id" name="plan.id"  value="%{plan.id}"/>
			            	<ww:hidden id="planID" name="planID" />
			            	<ww:hidden id="plan_recpNo" name="plan.recpNo"  value="%{plan.recpNo}"/>
				 ...
				 <td>	
						 <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="prompt_div_body" >							      						
								<TR>
										...
										<TD id="recpNo_div" class="tablefield" nowrap="nowrap" width="120" >
											计划名称
										</TD>
										<TD  id="recpNo_div" class="tablefield" nowrap="nowrap" width="100" >
										    部门
										</TD>
							 ...
							 <tbody id="items">
								<ww:if test="!RecruitplanList.isEmpty()">
									<ww:iterator value="RecruitplanList" status="index" >		
											...
											<td class="tablefield" nowrap="nowrap" width="120"><span class="view">	<ww:property value="recpNo"/></span></td>
